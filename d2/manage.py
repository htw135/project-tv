...
Usage:
    manage.py (drive) [--model=<model>] [--js] [--read]
...
from donkeycar.parts.controller import LocalWebController, reader, JoystickController
...
def drive(cfg, model_path=None, use_joystick=False, use_reader=False):
    ...
    if use_joystick or cfg.USE_JOYSTICK_AS_DEFAULT:
        ...
        pi = pigpio.pi()
        ctr = reader(pi, 12, 18,auto_record_on_throttle=cfg.AUTO_RECORD_ON_THROTTLE)
...
if __name__ == '__main__':
    ...
    if args['drive']:
        drive(cfg, model_path=args['--model'], use_joystick=args['--js'], use_reader=args['--read'])
